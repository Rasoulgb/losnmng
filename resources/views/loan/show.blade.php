            ...
            <h4 class="mb-3">Borrower Info </h4>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="search" name="reciver"  value="{{$viewData['reciver']}}" placeholder="Reciver" required disabled>
                        @error('reciver')
                ...
                <div class="row">
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" class="form-control" id="cc-expiration" name="amount" value="{{$viewData['amount']}}" placeholder="Loan Amount" disabled
                               required>
                               @error('amount')
                               <div class="alert alert-danger">{{ $message }}</div>
                           @enderror
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="date" class="date form-control" id="cc-cvv" name="start_date" value="{{$viewData['start_date']}}" required disabled>
                        @error('start_date')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="cc-number" name="number_of_instalments" value="{{$viewData['number_of_instalments']}}"  placeholder="Number Of Instalments" required disabled>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="cc-number" name="each_instalments_amount" value="{{$viewData['each_instalments_amount']}}" placeholder="Each instalment Amount" required disabled>
                ...
                <div class="form-check form-switch mx-4 ">
                    <input class="form-check-input justify=1"  type="checkbox" role="switch" id="flexSwitchCheckDefault" name="reminder"  {{ ($viewData['reminder'])=='' ? "" : 'checked'}}  disabled>
                    <label class="form-check-label" for="flexSwitchCheckDefault">  {{ ($viewData['reminder'])=='' ? "Dont Used Reminder" : 'Used Reminder'}}</label>
                  </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number"  list="values" step="1" min="1" max="7" class="form-range" id="cc-number" name="how_many_days_earlier" value="{{$viewData['how_many_days_earlier']}} "
                               placeholder="How many days earlier?" disabled >
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="cc-number" name="what_time" placeholder="whatTime" value="{{$viewData['what_time']}}" required disabled>
                    </div>

                </div>
                <hr class="mb-4">
  
                <a href="{{ route('instalment.show', [ $viewData[ 'loan_id'], 'total'=>true]) }}" >{{
                    $viewData['total']}}</a>,
                    <a href="{{ route('instalment.show', [ $viewData[ 'loan_id'], 'paied'=>true]) }}" >{{
                   $viewData['totalPaid']}}</a>,
                    <a href="{{ route('instalment.show', [ $viewData[ 'loan_id'], 'remind'=>true]) }}" >{{
                    $viewData['remind']}}</a></td>
